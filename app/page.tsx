          ...
          <div className="space-y-4">
            <details className="mt-4">
              ...
              <div className="p-4 bg-slate-50 border border-slate-300 rounded mt-2 space-y-2">
                ...
                <p>
                  Om ni ändå vill ge oss något så kan ni göra det genom att
                  skänka till en framtida bröllopsresa. Ni kan göra det genom
                  att swisha till{" "}
                  <a
                    className="underline decoration-dashed decoration-pink-600 text-pink-600"
                    href="#contact"
            ...
            <details>
              ...
              <div className="p-4 bg-slate-50 border border-slate-300 rounded mt-2 space-y-2">
                <p>
                  ...
                  barnen. Så vi tror att de kommer ha roligare med sina
                  barnvakter.
                </p>
                <p className="font-medium">
                  För de riktigt små barnen, så går det såklart jättebra att
                  vara med!
                </p>
                <p>
                  Vi kommer ha med våra barn under ceremonin, men under festen
                  får de hänga med barnvakt.
                </p>
              </div>
            </details>
            <details>
